...
###最初的特征参数来自于配置文件.yaml       E:\openpcdet代码\openpcdet代码\OpenPCDet-master\tools\cfgs\kitti_models\pointpillar.yaml
####根据config的不同，构造不同的网络
        model_info_dict = {
            'module_list': [],
...
###根据拓扑顺序和config中定义的顺序来构造网络，并传递后续的参数
...
###需要传递给后面层的特征参数
    ...
    def build_backbone_3d(self, model_info_dict):
        ...
        backbone_3d_module = backbones_3d.__all__[self.model_cfg.BACKBONE_3D.NAME](
            ...
            input_channels=model_info_dict['num_point_features'], #上一层输入的特征参数
            grid_size=model_info_dict['grid_size'],
            voxel_size=model_info_dict['voxel_size'],
            point_cloud_range=model_info_dict['point_cloud_range']
        )
